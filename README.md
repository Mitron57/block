...
Workflow [`.github/workflows/ci-cd.yml`](.github/workflows/ci-cd.yml): тесты на PR, на `main` — деплой в Railway (`railway up`). Секреты: `RAILWAY_TOKEN`, `RAILWAY_PROJECT_ID` в Settings → Secrets and variables → Actions.
